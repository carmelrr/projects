...
function linkFromData(n: Notification): string | null {
  ...
  if (d.threadId) return `/client/messages?threadId=${d.threadId}`;
  if (d.instanceId) return `/client/workout/${d.instanceId}`;
  return null;
}
...
export default function ClientNotificationsPage() {
  ...
  return (
    <div className="p-4 lg:p-8 space-y-6">
      <PageHeader
        title="Notifications"
        description="Stay on top of your training and messages."
        actions={
          unreadCount > 0 && (
            <Button
              variant="outline"
